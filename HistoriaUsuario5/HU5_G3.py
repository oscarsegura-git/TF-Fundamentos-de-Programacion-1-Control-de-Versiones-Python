nuevos_puntajes = obtener_puntajes_actualizados()

if not estan_completos(nuevos_puntajes):
    terminar_proceso()

lista_proveedores = asociar_puntajes_actualizados(nuevos_puntajes)
...
ranking_final = lista_proveedores
